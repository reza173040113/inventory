  ...
  Widget build(BuildContext context) {
    ...
    return _theme.page(
        ...
        content: Container(
          ...
          padding: EdgeInsets.only(top: 35, right: 54, left: 54, bottom: 0),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) => state.displayNameValidator(value),
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) => state.phoneNumberValidator(value),
